  ...
  return (
    <main id="main-content" className="page-main page-shell" tabIndex={-1}>
      ...
      <section id="works-live" className="section" aria-labelledby="live-title">
        ...
        <div className="works-list">{live.map((work, index) => <SpotlightCard key={work.slug} image={work.image} alt={`${work.nameZh}运行界面`} flip={index % 2 === 1} workSlug={work.detail ? work.slug : undefined}>
