...
export default function Home() {
  ...
  return (
    <main id="main-content" className="home-main" tabIndex={-1}>
      ...
      <section id="home-join" className="cta-band page-shell" aria-label="加入社团" data-reveal="group">
        <div className="space-y-1.5 text-left">
          <p className="font-mono text-xs text-[var(--accent)] font-bold tracking-widest uppercase">04 // RECRUITMENT</p>
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-[var(--fg)] m-0">
            {club.subSlogan}
          </h2>
        </div>
