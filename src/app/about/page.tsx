  ...
  return (
    <main id="main-content" className="page-main page-shell" tabIndex={-1}>
      ...
      <TrajectoryRail label="我们是谁" sections={[
        ...
        { id: "about-mechanism", index: "05", label: "运转机制" }, { id: "about-mentorship", index: "06", label: "师徒制" },
        { id: "about-advisor", index: "07", label: "指导老师" }, { id: "about-culture", index: "08", label: "文化" },
      ]} />
      ...
      <section id="about-culture" className="about-culture" aria-labelledby="culture-title"><p className="caps">08 / Culture</p><h2 id="culture-title">{club.values.map((value) => <span key={value}>[ {value} ]</span>)}</h2><p>{club.motto}</p></section>
    </main>
  );
}
