...
export default function AwardsPage() {
  ...
  return (
    <main id="main-content" className="page-main page-shell" tabIndex={-1}>
      ...
      <section id="awards-overview" className="section" aria-labelledby="overview-title"><div className="section__head"><p className="caps section__index">02 / Overview</p><h2 id="overview-title" className="section__title">赛事总览。</h2></div><DataTable caption="云飞扬社团竞赛成果总览" columns={[{ key: "competition", label: "竞赛" }, { key: "level", label: "级别" }, { key: "result", label: "成果" }]} rows={[...competitionOverview]} /></section>
      <section id="awards-archive" className="section" aria-labelledby="archive-title"><div className="section__head"><p className="caps section__index">03 / Archive</p><h2 id="archive-title" className="section__title">证书档案柜。</h2><p className="section__intro">公开图片均使用已脱敏版本；点击可查看完整档案。</p></div><CertArchive awards={certAwards} /></section>
    </main>
  );
}
