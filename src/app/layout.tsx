...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/favicon-light.svg?v=5", media: "(prefers-color-scheme: light)", type: "image/svg+xml", sizes: "any" },
      { url: "/favicon-dark.svg?v=5", media: "(prefers-color-scheme: dark)", type: "image/svg+xml", sizes: "any" },
    ],
  },
};
