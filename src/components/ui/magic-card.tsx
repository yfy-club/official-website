...
export function MagicCard(props: MagicCardProps) {
  ...
  return (
    <motion.div
      className={cn(
        "magic-card group relative isolate overflow-hidden rounded-[inherit] border border-transparent",
        className
      )}
    ...
    >
      <div className="magic-card__surface absolute inset-px z-20 rounded-[inherit]" />
