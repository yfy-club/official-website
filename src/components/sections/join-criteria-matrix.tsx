...
const CRITERIA_DIMENSIONS: readonly CriteriaDimension[] = [
  {
    index: "01",
    dimension: "研发动机与兴趣",
    dimensionEn: "ENGINEERING MOTIVATION",
  ...
  },
  {
    index: "02",
    dimension: "工位时间与专注",
    dimensionEn: "WORKSPACE COMMITMENT",
  ...
  },
  {
    index: "03",
    dimension: "技术追求与态度",
    dimensionEn: "CODE RIGOR & AI STANCE",
  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              ...
              <div className="p-5 sm:p-6 flex flex-col justify-between gap-3">
                <div className="flex items-center justify-between font-mono text-[11px] text-[var(--success)]">
                  <span className="font-semibold tracking-wider">
                    {item.index} // {item.dimension}
                  </span>
                  <span className="text-[10px] text-[var(--fg-faint)] hidden sm:inline">
                    {item.dimensionEn}
                  </span>
                </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 px-5 py-3 sm:px-6 border-t border-[var(--border)] bg-[var(--surface-2)]/25 font-mono text-[11px] text-[var(--fg-faint)]">
        <span>BENCHMARK // YFY-FIT-2026 · 双向奔赴与技术纯粹性准则</span>
        <span className="tabular">CRITERIA COUNT // 03 DIMENSIONS</span>
      </div>
    </CardFrame>
  );
}
